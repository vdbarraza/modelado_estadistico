...
```{r  fig.cap=" Heat map de correlación de algunas variablas", out.width="80%", fig.align="center", fig.width=5, fig.height=3}
library(GGally)
ggcorr(title[,26:32], label = TRUE, label_round = 2, label_size = 3.5, size = 2, hjust = .85) +
